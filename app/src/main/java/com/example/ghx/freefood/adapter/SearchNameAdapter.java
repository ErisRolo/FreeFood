...
public class SearchNameAdapter extends RecyclerView.Adapter<SearchNameAdapter.ViewHolder> {
    ...
    public SearchNameAdapter(Context context, List<Food> foodList) {
        mContext = context;
        mFoodList = foodList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewHolder holder = new SearchNameAdapter.ViewHolder(view);

        holder.searchNameView.setOnClickListener(new View.OnClickListener() {
            @Override
